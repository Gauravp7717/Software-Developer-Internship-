...
import { projects } from "../src/assets/seed.jsx";
...
const CaseStudy = () => {
  ...
  return (
    <div className="container mx-auto">
      ...
      <section>
        {/* differnt section starting from here */}
        <div className="flex flex-row-reverse w-[89%] top-4 right-4 z-50 items-center gap-4">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center justify-between gap-4 px-6 py-3 bg-white border border-gray-300  hover:border-gray-400 transition-colors duration-200 min-w-[280px]"
            >
              <span className="text-gray-700 font-medium">
                Browse by Industry
              </span>
