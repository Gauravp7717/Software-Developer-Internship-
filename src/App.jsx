        ...
        <section className="relative h-[80%] sm:h-[700px] md:h-[750px] lg:h-[800px] xl:h-[850px]  w-full flex items-center px-4 sm:px-6 md:px-16 lg:px-24 bg-cover bg-center bg-no-repeat">
          ...
          <div className="relative z-10 max-w-full sm:max-w-xl md:max-w-2xl lg:max-w-3xl text-white animate-fade-in px-4 sm:px-0">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl leading-relaxed mb-6 sm:mb-8 text-gray-100">
              User experience is the ultimate differentiator. Make sure your
              brand delivers exceptional experiences at every touchpoint.
            </p>
        ...
        <section className="bg-gray-50 py-16 px-8 md:px-16 lg:px-24">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed max-w-5xl mx-auto">
              While many enterprises struggle with a fragmented digital
              presence, we engineer ecosystems that ensure consistency across
              all channels to strengthen brand recognition. We combine deep
              domain expertise with human-centered design methodologies to
              design solutions that are technically feasible and aligned with
              business goals. Our engineering teams ensure the designed
              experience is flawlessly implemented and performs at scale.
            </p>
          </div>
        </section>
        {/* third section */}
        <section className="bg-white py-12 sm:py-16 px-4 sm:px-8 md:px-16 lg:px-24">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8 sm:mb-12">
              <p className="text-[10px] sm:text-xs md:text-sm font-semibold text-gray-800 uppercase tracking-wide mb-1 sm:mb-2">
                SOLUTION
              </p>
            ...
            <div className="group relative overflow-hidden rounded-3xl cursor-pointer border-2">
              ...
              <div className="relative z-10 p-6 sm:p-8 md:p-12 lg:p-16 text-black">
                ...
                <p className="text-lg sm:text-xl md:text-lg leading-relaxed mb-6 sm:mb-8 max-w-full sm:max-w-4xl lg:max-w-5xl">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 sm:mb-12">
              <div>
                ...
                <h2 className="text-1xl sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-snug sm:leading-tight">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-gray-50 rounded-2xl border border-gray-200 p-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    We focus on user-centered design to achieve business
                    outcomes and deep user satisfaction, effectively addressing
                    two key objectives.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-2xl border border-gray-200 p-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    We don't hand off a design and walk away. We are your
                    partner for both strategy and execution, eliminating the
                    friction of multi-vendor projects.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {insights.map((insight) => (
                <div
                  key={insight.id}
                  className="group cursor-pointer  rounded-4xl"
                >
                  <div
